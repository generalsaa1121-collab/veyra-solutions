...
// Keep LogoMark export so CTA.tsx ghost element still works
export function LogoMark({ size = 40, color = '#1C1917' }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={Math.round(size * 1.09)} viewBox="0 0 44 48" fill="none" aria-hidden="true">
