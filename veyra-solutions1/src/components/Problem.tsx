      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="border-t border-border">
          {gaps.map((gap, i) => (
            <div
              key={gap.n}
              className={`border-b border-border py-10 lg:py-14 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-16 reveal ${visible ? 'visible' : ''}`}
              style={{ transitionDelay: `${0.08 + i * 0.08}s` }}
            >
              <div className="lg:col-span-1">
                <span
                  className="font-display font-bold text-border-strong select-none"
              ...
              <div className="lg:col-span-5">
                <h3
                  ...
                  style={{ fontSize: 'clamp(1.05rem, 1.8vw, 1.35rem)', letterSpacing: '-0.015em', lineHeight: 1.3 }}
                >
                  {gap.title}
                </h3>
              </div>
